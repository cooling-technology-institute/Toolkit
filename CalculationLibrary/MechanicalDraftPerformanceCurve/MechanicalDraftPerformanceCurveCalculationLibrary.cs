...
namespace CalculationLibrary
{
    public class MechanicalDraftPerformanceCurveCalculationLibrary : CalculationLibrary
    {
		public void MechanicalDraftPerformanceCurveCalculation(int testIndex, MechanicalDraftPerformanceCurveFileData data, MechanicalDraftPerformanceCurveOutput output)
        {
            ...
            //Init Others
            double TestWetBulbTemperature = data.TestData[testIndex].TowerSpecifications.WetBulbTemperature;
            double TestR = data.TestData[testIndex].TowerSpecifications.HotWaterTemperature - data.TestData[testIndex].TowerSpecifications.ColdWaterTemperature;
            double TestColdWaterTemperature = data.TestData[testIndex].TowerSpecifications.ColdWaterTemperature;
